...
Begin VB.Form frmdaftarkelas 
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.Image Image1 
         Height          =   855
         Left            =   75
         Picture         =   "frmdaftarkelas.frx":0000
         Top             =   75
         Width           =   810
      End
      ...
      Begin MSComctlLib.ImageList ImageList1 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmdaftarkelas.frx":24C8
               Key             =   ""
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmdaftarkelas.frx":355A
               Key             =   ""
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmdaftarkelas.frx":45EC
               Key             =   ""
            EndProperty
            BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmdaftarkelas.frx":567E
               Key             =   ""
            EndProperty
            BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmdaftarkelas.frx":6710
               Key             =   ""
            EndProperty
            BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmdaftarkelas.frx":77A2
               Key             =   ""
            EndProperty
            BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmdaftarkelas.frx":8834
               Key             =   ""
            EndProperty
         EndProperty
      End
   End
End
Attribute VB_Name = "frmdaftarkelas"
...
Private Sub DataGrid1_DblClick()
    frmentryKelas.Show
    frmentryKelas.EditData (DataGrid1.Columns(1).Value)
End Sub

Private Sub Form_Load()
    Set oKelas = New DLLBK.Ckelas
    Set DataGrid1.DataSource = oKelas.List(True, "Order by kelas")
End Sub
...
If MsgBox("Apakah Anda Yakn Akan Menghapus Data???", vbYesNo + vbQuestion) = vbNo Then Exit Sub
    If oKelas.Delete(DataGrid1.Columns(1).Value) > 0 Then
...
Select Case UCase(Button.key)
    ...
    Case "NEW": Call frmentryKelas.Show
